...
const DeanStu: FC<HotTableProps> = () => {
  const { hotRef, gridRows, isSaving, handleSave, handleAdd, studentTypes } =
    useStudentGrid("Dean's Office");
  const { roomOptions } = useRoom("DeaneryLevel2");

  return (
    <div className="p-4">
      <div className="flex items-center justify-between mb-4">
        <div className="font-black text-2xl">Dean&apos;s Office Student</div>
